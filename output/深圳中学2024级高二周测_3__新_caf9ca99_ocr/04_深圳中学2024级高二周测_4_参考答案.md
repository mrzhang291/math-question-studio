...
所以函数 $g(x)$ 在 $(0, e)$ 上单调递增，在 $(e, +\infty)$ 上单调递减，且 $g(1) = 0$ ，有极大值也是最大值 $g(e) = \frac{3}{e}$ ，如图：
...
（3）方法一：依题意 $\left\{\begin{aligned}\mathrm{e}^{m}&=\frac{a}{n}\\ \mathrm{e}^{n}&=\frac{a}{m}\end{aligned}\right.$ ，因为 m>0, n>0，所以 a>0，
...
所以 $A(t)$ 在 $(1,+\infty)$ 上单调递增，又当 $t\to1$ 时， $\frac{\ln t}{t-1}\to1$ ，所以 $A(t)\to\mathsf{e}$ ，故 a 的取值范围是 $(\mathsf{e},+\infty)$ .
